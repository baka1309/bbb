...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:10px">
    <div class="w3-bar w3-black  ">
        ...
        <a href="filter.php"  style="border-radius: 10px;width: 100px;height: 30px;float: right;margin-top: 5px"><b>Фильтр</b></a>
    </div>
    <div class="container mb-3">
        <h1 class="text-center"> Введите ваши данные</h1><hr>
        <form action="" method="post">
            <div class="row mt-5 ">
                <div class="col-6 display-4">
                    ...
                    <button type="submit" style="background: #1b1e21;border-radius: 10px;color: white">Поиск</button>
                </div>
            </div>
        </form>
       </div>
