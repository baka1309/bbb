...
<div class="w3-content" style="max-width:1200px;margin-top: 15px">
    ...
    <div class="w3-main" ">
        ...
        <header class="w3-container w3-xlarge">
            ...
            <p class="w3-right">
                <a href="addBook.php" style="margin-right: 10px; color: black"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
