...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
    ...
    <div class="w3-padding-64 w3-large w3-text-black text-left" style="font-weight:bold">
        <?php
        ...
        { ?>
            ...
            <a href="education.php?id=<?php echo $row['id']?>"><?php echo $row['name']?></a><br>
        <?php }
        ?>
    </div>
        <div class="w3-padding-64 w3-large w3-text-black text-left" style="font-weight:bold">
    ...
    <a href="registration.php" >Вход</a><br>
</div>
</nav>
...
<div class="w3-main" style="margin-left:250px">
    ...
    <div class="w3-row w3-grayscale">
        ...
        $g_row =  $pdo_conn->query("SELECT * FROM all_book LIMIT ".strval($pages).", 8") ;
        $size1 = $count;
        foreach($g_row as $row)
        {
            ?>
    ...
    <div class="w3-center w3-padding-32">
        <div class="w3-bar">
            <?php for ($num = 0; $num<$size1/8; $num++){
                ?>
                <a href="bookstore.php?page=<?php echo $num*8?>" class="w3-bar-item w3-button w3-hover-black"><?php echo $num+1 ?></a>
                <?php
            }
            ?>
        </div>
