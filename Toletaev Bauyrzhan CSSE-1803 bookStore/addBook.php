...
<div class="w3-content" style="max-width:1200px;margin-top: 15px">
    ...
    <header class="w3-container w3-xlarge">
        <p class="w3-left">  <a type="button" href="profile.php"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-left-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-4.5.5a.5.5 0 0 0 0-1H5.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708L5.707 8.5H11.5z"/>
                </svg></a> Add New Book++</p>
        <p class="w3-right">
    ...
    <form action = "" method="post">
        <div style="margin-left: 50px">
            ...
            <input   size="62px" type="text" name = "url"  id="13"><br>
...
if(!empty($_POST['name'])) {
    require_once "connection.php";
    $sql = "insert into all_book (name, author_name, cost, picture,cat_id) values (:pn, :mn, :sn, :ps,:cd)";
    $pnn = $_POST['name'];
    $mnn = $_POST['author'];
    $snn = $_POST['cost'];
    $pss = $_POST['url'];
