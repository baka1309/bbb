...
<div class="w3-content" style="lmax-width:1200px;margin-top: 15px">
    <div class="w3-overlay w3-hide-large" onclick="w3_close()" style="cursor:pointer" title="close side menu" id="myOverlay"></div>
    <div class="w3-main" ">
    <div class="w3-hide-large" style="margin-top:83px"></div>
    <header class="w3-container w3-xlarge">
        <p class="w3-left">
            <a type="button" href="profile.php"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-left-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        $sql="UPDATE all_book SET name = :pn,author_name=:mn,cost=:tn,new_books_id=:ni,picture=:pr,basket_id=:bi,cat_id=:cd WHERE book_id = :id";
        echo "<pre>\n$sql\n</pre>\n";
        $stmt = $pdo_conn->prepare($sql);
        $stmt->execute(array(':id'=>$_POST['id'], ':pn'=>$_POST['name1'], ':mn'=>$_POST['author1'], ':tn'=>$_POST['cost1'],':ni'=>2, ':pr'=>$_POST['url1'],':bi'=>3,':cd'=>$_POST['cat_id']));
    ...
    <form action = "" method="post">
        <div style="margin-left: 50px">
            ...
            <input value="<?php echo $picture?>"   size="62px" type="text" name = "url1"  id="13"><br>
            <label  for="13">Choose category:</label><br>
            <select name="cat_id" style="width: 533px;height:30px">
                <?php

                $category="SELECT * FROM category";

                require_once "connection.php";
                $g_row =  $pdo_conn->query($category) ;
